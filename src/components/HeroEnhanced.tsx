...
const HeroEnhanced = () => {
  ...
  const taglines = [
    ...
    "Shaping Minds. Building Futures. Creating Legacy.",
    "Bridging Traditions with Modern Education."
  ];
      ...
      <div className="container mx-auto px-4 z-10 text-center">
        ...
        >
          <img 
            ...
            className="h-24 md:h-32 mx-auto filter drop-shadow-lg"
          />
        </motion.div>
        ...
        <motion.h1 
          ...
          initial="initial"
          animate="animate"
          className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-8 font-playfair tracking-tight"
        >
          Dr. P.T. Abdul Rahman
        </motion.h1>
        ...
        <motion.div 
          ...
          initial="initial"
          animate="animate"
          className="text-xl md:text-2xl text-golden-300 mb-12 tracking-wide h-8"
        >
          <Typewriter 
            texts={taglines} 
            typingSpeed={60} 
