...
const timelineEvents: TimelineEvent[] = [
  {
    ...
    achievements: [
      "Studies at Palakkod East Masjid under T.P. Muhammad Musliar",
      "Advanced Islamic jurisprudence at Edakazhiyoor Juma Masjid",
      "Mentorship under Kallur Abdullah Musliar"
    ],
    type: "education"
  },
  {
    ...
    achievements: [
      "Graduate degree from prestigious Indian university",
      "Specialized in social dynamics and community development",
      "Academic preparation for institutional leadership"
    ],
    type: "education"
  },
  {
    ...
    achievements: [
      "Founded first major Indian Islamic institution in Dubai",
      "Established sustainable community welfare programs",
      "Created model for expatriate community organization"
    ],
    type: "founding"
  },
  {
    ...
    achievements: [
      ...
      "Cross-cultural military administration experience",
      "Leadership development in structured environment"
    ],
    type: "career"
  },
  {
    ...
    achievements: [
      "Multi-language philosophical work",
      "Government department publication",
      "Foundation of literary career"
    ],
    type: "publication"
  },
  {
    ...
    achievements: [
      "Nine years of specialized research",
      "Government-level policy contribution",
      "Academic research in applied Islamic studies"
    ],
    type: "career"
  },
  {
    ...
    achievements: [
      "Pioneering interfaith television programming",
      "Model adopted by other Malayalam channels",
      "Media innovation in religious dialogue"
    ],
    type: "recognition"
  },
  {
    ...
    achievements: [
      "Students represent India at international competitions",
      "Dubai International Holy Quran Award participants",
      "Model educational institution inspiring nationwide adoption"
    ],
    type: "founding"
  },
  {
    ...
    achievements: [
      "Extensive Arabic literary contribution",
      "Scholarly recognition in Arabic-speaking world",
      "Major biographical and historical work"
    ],
    type: "publication"
  },
  {
    ...
    achievements: [
      "Expansion of educational innovation model",
      "Integration of cultural preservation with modern pedagogy",
      "Leadership in educational institutional development"
    ],
    type: "founding"
  },
  {
    ...
    achievements: [
      "Government recognition for social impact",
      "Formal acknowledgment of humanitarian contributions",
      "Distinguished status for community service"
    ],
    type: "recognition"
  },
  {
...
const ProfessionalTimeline: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-royal-50 to-golden-50">
            ...
            return (
              ...
              >
                ...
                <div className={`w-5/12 ${isEven ? 'pr-12' : 'pl-12'}`}>
                  <div className="bg-white rounded-xl p-6 shadow-lg border border-royal-100 hover:shadow-xl transition-all duration-300">
                    {/* Year Badge */}
                    ...
                    <div>
                      ...
                      <ul className="space-y-1">
                        {event.achievements.map((achievement, achievementIndex) => (
                          <li key={achievementIndex} className="text-royal-600 text-sm flex items-start">
