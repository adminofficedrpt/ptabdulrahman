...
const timelineEvents: TimelineEvent[] = [
  ...
  { year: "1990s", title: "DQAA Academy Founded", description: "Established Darul Quran Abdulla Academy in Dubai.", location: "Dubai, UAE" },
  ...
  { year: "2009", title: "Welfare Initiatives", description: "As DIIC President, launched welfare schemes and medical camps for the Indian expatriate community.", location: "Dubai, UAE" },
  ...
  { year: "2014", title: "Educational Programs", description: "DIIC hosted 8th annual Inter-School Quran and Educational Competition.", location: "Dubai, UAE" },
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mx-auto relative">
          ...
          {timelineEvents.map((event, index) => (
            <motion.div
              key={index}
              className="relative flex items-start mb-12 last:mb-0 pl-12 md:pl-20"
            ...
            >
              ...
              <div className="absolute left-4 md:left-8 -translate-x-1/2 top-1">
                <div className="w-2.5 h-2.5 rounded-full bg-golden-500" />
              </div>
