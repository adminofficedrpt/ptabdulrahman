        ...
        <div className="group relative">
          ...
          <div className="relative bg-black/70 backdrop-blur-md border border-white/10 rounded-lg px-4 py-2 text-xs text-white/90 hover:text-white transition-all duration-300">
            <div className="flex items-center space-x-2">
              ...
              <a href="https://ai8ty.com" target="_blank" rel="noopener noreferrer" className="font-bold bg-gradient-to-r from-golden-400 to-royal-400 bg-clip-text text-transparent hover:from-golden-300 hover:to-royal-300 transition-all duration-300">
                AI8TY
              </a>
            </div>
          </div>
