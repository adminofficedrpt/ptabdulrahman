  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10 text-center">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 font-playfair animate-fade-in opacity-0" style={{ animationDelay: '0.3s' }}>
          Dr. P.T. Abdul Rahman
        </h1>
        
        <h2 className="text-xl md:text-2xl text-golden-300 mb-10 tracking-wide animate-fade-in opacity-0" style={{ animationDelay: '0.5s' }}>
          Islamic Scholar UAE | Indian Humanitarian in Dubai | Author | Founder of Darul Quran Abdulla Academy
        </h2>
        
        <div className="max-w-3xl mx-auto mb-14 animate-fade-in opacity-0" style={{ animationDelay: '0.7s' }}>
