      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
          <div className="md:col-span-5 lg:col-span-4">
            <Link to="/" aria-label="Dr. P.T. Abdul Rahman">
              <img 
            ...
            <p className="text-gray-300 mb-8 max-w-md">
              Dr. P.T. Abdul Rahman is a distinguished Islamic scholar, educator, humanitarian, 
              and veteran in legal affairs with over three decades of service across UAE and India.
            </p>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((link, index) => (
                <motion.a
                  ...
                  className="bg-royal-800 hover:bg-royal-700 transition-colors duration-300 p-3 rounded-full"
          ...
          <div className="md:col-span-7 lg:col-span-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              <div>
                <h3 className="text-lg font-medium text-golden-400 mb-6">Quick Links</h3>
              ...
              <div>
                <h3 className="text-lg font-medium text-golden-400 mb-6">Our Work</h3>
                <ul className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-medium text-golden-400 mb-6">Contact</h3>
                <address className="not-italic text-gray-300 space-y-4">
                  <p>Dubai Indian Islamic Centre,<br />Al Rigga Road, Deira,<br />Dubai, UAE</p>
                  <p>
                    <a 
                      href="mailto:info@ptabdulrahman.com" 
                      className="hover:text-white transition-colors duration-300"
                    >
                      info@ptabdulrahman.com
                    </a>
                  </p>
                  <p>
                    <a 
        ...
        <div className="border-t border-royal-800 pt-8 mt-8 text-center sm:text-left sm:flex sm:justify-between sm:items-center">
          <p className="text-gray-400">&copy; {year} Dr. P.T. Abdul Rahman. All rights reserved.</p>
