...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-royal-50 relative overflow-hidden">
      <div className="container mx-auto px-4">
        <SectionHeading 
          title="Get in Touch" 
          subtitle="For inquiries about Dr. Rahman's work, speaking engagements, or collaboration opportunities"
          className="mb-16"
        />
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-royal-100 p-3 rounded-lg mr-4">
                    <Map className="h-6 w-6 text-royal-700" />
                  </div>
                  <div>
                    <h4 className="font-medium text-royal-800 mb-1">Office Address</h4>
                    <p className="text-gray-600">Dubai Indian Islamic Centre,<br />Al Rigga Road, Deira,<br />Dubai, United Arab Emirates</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@ptabdulrahman.com</p>
                ...
                <div className="flex items-start">
                  <div className="bg-royal-100 p-3 rounded-lg mr-4">
                    <Phone className="h-6 w-6 text-royal-700" />
                  </div>
                  <div>
                    <h4 className="font-medium text-royal-800 mb-1">Phone</h4>
                    <p className="text-gray-600">+971 4 123 4567</p>
                    <p className="text-gray-600">+91 123 456 7890 (India Office)</p>
                  </div>
                </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div>
                  <Button 
                    ...
                    className="bg-gradient-to-r from-royal-700 to-royal-800 hover:from-royal-800 hover:to-royal-900 text-white px-8 py-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 w-full sm:w-auto"
                  >
