...
const TestimonialsSection = () => {
  ...
  return <section className="py-16 md:py-24 bg-gradient-to-br from-gray-50 to-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          delay: index * 0.2
              ...
              <div className="flex mb-4">
                {[...Array(testimonial.rating)].map((_, i) => <Star key={i} className="w-5 h-5 text-golden-500 fill-current" />)}
              </div>
