      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-700">A distinguished Islamic scholar in UAE, visionary leader, and Indian humanitarian in Dubai whose influence spans continents.</p>
          </div>

          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="absolute -top-3 -left-3 w-64 h-64 bg-golden-100 rounded-lg"></div>
              <img alt="Dr. P.T. Abdul Rahman - Malayali scholar in UAE" className="relative z-10 w-full h-auto rounded-lg shadow-lg" src="/lovable-uploads/fb28198e-3760-4921-aaba-ddca06433f3a.jpg" />
            </div>
