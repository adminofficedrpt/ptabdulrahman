...
const Humanitarian = () => {
  ...
  return <section id="humanitarian" className="py-24 bg-white relative overflow-hidden">
      {/* Background image with overlay */}
      <div className="absolute inset-0 bg-cover bg-center opacity-10" style={{
      backgroundImage: `url('/lovable-uploads/40bbf3ea-9c2c-4b7d-a391-c948fb701d74.png')`
    }}></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto" ref={sectionRef}>
          {initiatives.map((initiative, index) => <div key={initiative.id} id={initiative.id} className={`humanitarian-item rounded-lg bg-white shadow-lg p-8 border border-gray-100 hover:border-golden-300 transition-all duration-300 ${visibleItems.includes(initiative.id) ? 'animate-fade-in opacity-0' : 'opacity-0'}`} style={{
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <div className="rounded-lg overflow-hidden shadow-lg">
            <img src="/lovable-uploads/6856dd37-63cb-4029-b897-0b2143071d2f.png" alt="Dr. Rahman receiving recognition" className="w-full h-60 object-cover" />
          </div>
          <div className="rounded-lg overflow-hidden shadow-lg">
            <img alt="Dr. Rahman with UAE leaders" src="/lovable-uploads/66572de8-7486-4f48-ac7f-1219779e9bd6.jpg" className="w-full h-60 object-cover" />
          </div>
          <div className="rounded-lg overflow-hidden shadow-lg">
            <img src="/lovable-uploads/37251c4b-0591-433c-bbce-ac4291fc7ddb.png" alt="Dr. Rahman receiving honor" className="w-full h-60 object-cover" />
          </div>
        </div>
      </div>
    </section>;
