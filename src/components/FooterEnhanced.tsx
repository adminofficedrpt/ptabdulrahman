...
const FooterEnhanced = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-royal-900 to-royal-950 text-white py-20" role="contentinfo" aria-label="Site footer">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <motion.div variants={footerItem}>
            ...
            <div className="mt-8">
              <a 
                href="https://www.darul-quran.com" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="inline-flex items-center text-golden-300 hover:text-golden-200 transition-all duration-300"
                aria-label="Visit Darul Quran website (opens in new tab)"
              >
                Visit Darul Quran Website
                <ArrowUp className="ml-2 h-4 w-4 rotate-45" aria-hidden="true" />
              </a>
            </div>
          </motion.div>
        </motion.div>
        
        <AnimatedSection className="border-t border-royal-800/50 mt-16 pt-10 text-center" delay={0.4}>
          <p className="text-golden-200/50">&copy; {currentYear} All Rights Reserved | Dr. P.T. Abdul Rahman | Darul Quran Abdulla Academy</p>
        </AnimatedSection>
      </div>
    </footer>
  );
